...
# Reading the data
store_details = read_dataset("../data/store.csv")
train_data = read_dataset("../data/train.csv")
...
# print("####### hyperparameter_optimization  ##########")
# #hyperparameter optimization
# model_dict=models()
# best_models=hyperparameter_optimization(X, y, model_dict, scoring='r2_score', cv=3)
# print(best_models)